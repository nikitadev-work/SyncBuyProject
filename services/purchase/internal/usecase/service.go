...
// Participant
func (uc *PurchaseUsecase) CreateInvite(ctx context.Context, input CreateInviteInputDTO) (*CreateInviteOutputDTO, error) {
	//TODO
	return nil, nil
}

func (uc *PurchaseUsecase) JoinByInvite(ctx context.Context, input JoinByInviteInputDTO) error {
	//TODO
	return nil
}
